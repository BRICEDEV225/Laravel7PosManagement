                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('user.update',$user->id)}}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="name" id="" class="form-control" value="{{user}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Email</label>
                                                                <input type="email" name="email" id="" class="form-control" value="{{user}}">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" name="password" id="" class="form-control" value="{{user}}">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Confirm Password</label>
                                                                <input type="password" name="confirm_password" id="" class="form-control" value="{{user}}">
                                                            </div>
                                                            <div class="form-group">
