                                ...
                                <tbody>
                                    @foreach ($users as $key => $user)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" data-toggle="modal" data-target="#editUser{{$user->id}}" class="btn btn-info btn-sm">
                                        ...
                                        <div class="modal right fade" id="editUser{{$user->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <h4 class="modal-title" id="staticBackdropLabel">Edit user Detail</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('user.update',$user->id)}}" method="post">
                                                            ...
                                                            {{-- <div class="form-group">
                                                                ...
                                                                <input type="text" name="phone" id="" class="form-control" value="{{user->}}">
                                                            </div> --}}
                                                            <div class="form-group">
                                        ...
                                        {{-- Modal --}}
                                        <div class="modal right fade" id="deleUser{{$user->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
