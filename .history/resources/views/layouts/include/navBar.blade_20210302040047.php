...
<a href="{{route('user')}}" class="btn btn-outline rounded-pill"><i class="fa fa-user"></i>Users</a>
<a href="#" class="btn btn-outline rounded-pill"><i class="fa fa-box"></i>Products</a>
<a href="#" class="btn btn-outline rounded-pill"><i class="fa fa-laptop"></i>Cashire</a>
